...
var replacements = []string{
    `(?m)^package MumbleProto;$`, `option go_package = "github.com/CodingVoid/gomble/mumbleproto";`,
...
func main() {
    ...
    if err := exec.Command("protoc", "--go_opt=paths=source_relative",  "--go_out=.", "Mumble.proto").Run(); err != nil {
        log.Fatal(err)
    }
}
